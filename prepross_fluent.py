...
def download_and_extract_dataset(url, extract_path):
    local_zip_path = extract_path / "fluent_speech_commands.zip"
...
DATASET_PATH = 'data/fluent_speech_commands'

data_dir = pathlib.Path(DATASET_PATH)
if not data_dir.exists():
    data_dir.mkdir(parents=True, exist_ok=True)
    download_and_extract_dataset("https://zenodo.org/record/4051504/files/fluent_speech_commands.tar.gz", data_dir)
